        ...
        <main className="page_container">
            ...
            <div className={style.about}>
                <section className={style.bio}>
                    ...
                    <p className={style.grey}>Por ejemplo los electricistas habitualmente trabajamos con sistemas complejos, la capacidad para resolver problemas y la deteccion de fallas son aptitudes fundamentales en esta profesion. Ademas trabajamos con una amplia cantidad de herramientas y constantemente tenemos que adaptarnos y aprender nuevas tecnologias, algo comun en el campo de desarrollo web. Por ultimo, regularmente trabajo en equipos con otros electricistas, saber trabajar y comunicarse con miembros del equipo es fundamental para alguien en este rubro.</p>
                </section>

                <section className={style.pregunta_estudio}>
                    <h2>Por que estudio desarrollo web?</h2>
                    <p>Cuando me recibi my primer inclinacion fue estudiar programacion, por desgracia no supe encarar la carrera, que estudiar o donde, y en su lugar estudie ingenieria electrica y trabaje en paralelo.</p>
                    <p>Finalmente despues de años puede darme el gusto y comenze la carrera de Analista de Sistemas la cual me encuentro cursando. Algo que puede rescatar de mis estudios de ingeniera es que me dejo una fuerte experiencia en la matematica, la cual sirvio mucho en mis actuales estudios.</p>
                </section>
