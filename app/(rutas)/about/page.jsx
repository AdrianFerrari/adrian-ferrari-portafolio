      ...
      <div className={style.about}>
        <section className={style.bio}>
          ...
          <p className={style.grey}>
            Ser electricista no tiene una correlacion directa con el mundo del desarrollo de software pero hay muchas
            habilidades claves que son comunes a ambos sectores y me han servido de mucho en el campo de la
            programacion.
          </p>
          <p>
            Por ejemplo los electricistas habitualmente trabajamos con sistemas complejos, la capacidad para resolver
            problemas y la deteccion de fallas son aptitudes fundamentales en esta profesion. Ademas trabajamos con una
            amplia cantidad de herramientas y constantemente tenemos que adaptarnos y aprender nuevas tecnologias, algo
            comun en el campo de desarrollo web. Por ultimo, regularmente trabajo en equipos con otros electricistas,
            saber trabajar y comunicarse con miembros del equipo es fundamental para alguien en este rubro.
          </p>
        </section>
        ...
        <aside className={style.educacion_container}>
          ...
          <a className={style.download_cv_btn} href="/adrian-ferrari-cv.pdf" download>
            Download CV
          </a>
        </aside>
      </div>
